    ...
    <div className="flex flex-1 flex-col gap-4 p-4">
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <Link
          ...
          className="rounded-lg border border-gray-200 bg-white p-4 hover:border-blue-300 transition"
        >
          <p className="text-sm font-semibold text-gray-900">🤖 Auto Dialer</p>
          <p className="text-xs text-gray-500 mt-1">Work through your contact list</p>
        </Link>
        <Link
          href="/call-history"
          className="rounded-lg border border-gray-200 bg-white p-4 hover:border-blue-300 transition"
      ...
      <div className="rounded-lg border border-gray-200 bg-white p-4">
        ...
        {!loadError && calls.length > 0 && (
          <ul className="divide-y divide-gray-100">
            {calls.map((call) => (
              <li key={call.sid} className="py-2 flex items-center justify-between text-sm">
